...
entity_template = Template(open('templates/cdm/entity.md').read())
for k,v in all_standard_entities.items():
...
# Entity Jinja Template
table_template = Template(open('templates/cdm/table.md').read())
...
with open('templates/cdm/toc_template.json') as json_file:
