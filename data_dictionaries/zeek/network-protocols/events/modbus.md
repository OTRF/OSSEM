...
|TBD|function|TBD|string|The name of the function message that was sent.|READ_COILS_EXCEPTION"|
|TBD|exception|TBD|string|The exception if the response was a failure.|ILLEGAL_DATA_VALUE|
|TBD|track_address|TBD|integer|present if policy/protocols/modbus/track-memmap.bro is loaded)|``|
