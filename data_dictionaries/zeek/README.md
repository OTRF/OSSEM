...
|[Zeek Network Control Event Logs](netcontrol/)|Zeek can connect with network devices like, for example, switches or soft- and hardware firewalls using the NetControl framework.|
|[Zeek Network Observations Event Logs](network-observations/)|Data collected about certificates, software, hosts, modbus, software, services/applications, etc.|
|[Zeek Network Protocol Event Logs](network-protocols/)|Network protocol/application logs containing all the metadata it collects and records for that specific protocol.|
