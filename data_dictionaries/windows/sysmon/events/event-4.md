...
|---|---|---|---|---|
|event_date_creation|UtcTime|TBD|date|Time in UTC when event was created|4/11/18 5:36|
|service_state|State|TBD|string|sysmon service state (i.e. stopped)|Stopped|
|file_version|Version|TBD|string|sysmon version|7.01|
|sysmon_schema_version|SchemaVersion|TBD|string|sysmon config schema version|4|
