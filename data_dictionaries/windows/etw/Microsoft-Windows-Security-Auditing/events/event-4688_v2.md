...
|TBD|NewProcessId|Pointer|None|`None`|
|TBD|NewProcessName|UnicodeString|None|`None`|
|TBD|TokenElevationType|UnicodeString|None|`None`|
...
|TBD|ParentProcessName|UnicodeString|None|`None`|
