...
|TBD|ImpersonationLevel|UnicodeString|None|`None`|
|TBD|RestrictedAdminMode|UnicodeString|None|`None`|
|TBD|TargetOutboundUserName|UnicodeString|None|`None`|
|TBD|TargetOutboundDomainName|UnicodeString|None|`None`|
|TBD|VirtualAccount|UnicodeString|None|`None`|
|TBD|TargetLinkedLogonId|HexInt64|None|`None`|
|TBD|ElevatedToken|UnicodeString|None|`None`|
