...
|---|---|---|---|---|
|powershell_command_invocation|CommandInvocation|TBD|string||Get-ChildItem|
|powershell_parameter_binding|ParameterBinding|TBD|string||Filter|
|powershell_severity|Severity|TBD|string||Informational|
|powershell_host_name|HostName|TBD|string||ConsoleHost|
|powershell_host_version|HostVersion|TBD|string||5.1.16299.431|
|powershell_host_id|HostId|TBD|string||312b26a7-53d3-45db-8b45-b79cae3afba9|
|powershell_host_application|HostApplication|TBD|string||C:\Windows\System32\WindowsPowerShell\v1.0\powershell.exe|
|powershell_engine_version|EngineVersion|TBD|string||5.1.16299.431|
|powershell_runspace_id|RunspaceId|TBD|string||0252cd51-52b5-4825-8029-a4f81a93cef6|
|powershell_pipeline_id|PipelineId|TBD|integer||35|
|powershell_command_name|CommandName|TBD|string||Get-ChildItem|
|powershell_command_type|CommandType|TBD|string||Cmdlet|
|powershell_script_name|ScriptName|TBD|string|||
|powershell_command_path|CommandPath|TBD|string|||
|powershell_sequence_number|Sequence Number|TBD|string||88|
|user_name|User|TBD|string||wardog|
|user_domain|User|TBD|string||DESKTOP-WARDOG|
|powershell_connected_user|Connected User|TBD|string|||
|powershell_shell_id|Shell ID|TBD|string||Microsoft.PowerShell|
