...
|---|---|---|---|---|
|powershell_new_engine_state|NewEngineState|TBD|string||Stopped|
|powershell_previous_engine_state|PreviousEngineState|TBD|string||Available|
|powershell_sequence_number|SequenceNumber|TBD|integer||13|
|powershell_host_name|HostName|TBD|string||Windows PowerShell ISE|
|powershell_host_version|HostVersion|TBD|string||5.1.16299.64|
|powershell_host_id|HostId|TBD|string||26572281-9dcd-4297-ae4b-d6bb52bdaff6|
|powershell_host_application|HostApplication|TBD|string||C:\WINDOWS\system32\WindowsPowerShell\v1.0\PowerShell_ISE.exe|
|powershell_engine_version|EngineVersion|TBD|string||5.1.16299.64|
|powershell_runspace_id|RunspaceId|TBD|string||aba09534-39f7-4ec3-aa46-8c709c39cf5a|
