...
|---|---|---|---|---|
|user_sid|TargetUserSid|SID|SID of account that requested the "lock workstation" operation|`S-1-5-21-3457937927-2839227994-823803824-1104`|
|user_name|TargetUserName|UnicodeString|the name of the account that requested the "lock workstation" operation.|`dadmin`|
...
|user_session_id|SessionId|UInt32|unique ID of locked session.|`3`|
