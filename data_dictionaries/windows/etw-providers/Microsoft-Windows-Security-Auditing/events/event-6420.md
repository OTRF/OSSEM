...
|---|---|---|---|---|
|user_sid|SubjectUserSid|SID|SID of account that disabled the device.|`S-1-5-18`|
|user_name|SubjectUserName|UnicodeString|the name of the account that disabled the device.|`DESKTOP-NFC0HVN$`|
