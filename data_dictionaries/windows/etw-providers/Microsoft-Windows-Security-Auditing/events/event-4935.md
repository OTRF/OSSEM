...
|---|---|---|---|---|
|replication_event|ReplicationEvent|UInt32|there is no detailed information about this field in this document.|`1`|
|audit_status_code|AuditStatusCode|UInt32|there is no detailed information about this field in this document.|`8419`|
