...
|TBD|fid_NegativeCredit|UInt8|None|`None`|
|TBD|fid_EndOfTransfer|UInt8|None|`None`|
|TBD|fid_NumberOfIsochHeaders|UInt16|None|`None`|
|TBD|fid_MTDValid|UInt8|None|`None`|
|TBD|fid_ASAPDelivery|UInt8|None|`None`|
|TBD|fid_PresentationTime|UInt32|None|`None`|
|TBD|fid_NumberOfIsochSegments|UInt16|None|`None`|
|TBD|fid_NominalBusInterval|UInt32|None|`None`|
