# Event 82 - PassiveCoolingOperational
...
|TBD|PassiveCoolingStateLength|UInt16|None|`None`|
|TBD|PassiveCoolingState|UnicodeString|None|`None`|
|TBD|AffinityCount|UInt16|None|`None`|
...
|TBD|_PSL|Boolean|None|`None`|

## Tags
* etw_level_Informational
* etw_keywords_po:Thermal
* etw_task_PassiveCoolingOperational