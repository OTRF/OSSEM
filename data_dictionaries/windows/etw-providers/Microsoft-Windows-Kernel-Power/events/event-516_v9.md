...
|TBD|DirectedDripsTransitionCount|UInt32|None|`None`|
|TBD|IsHibernateEnabled|Boolean|None|`None`|
|TBD|HibernateTimeoutInSec|UInt32|None|`None`|
|TBD|HibernateBudgetPercentage|UInt32|None|`None`|
|TBD|IsLockConsoleTimeoutActive|Boolean|None|`None`|
|TBD|IsDebuggerEnabled|Boolean|None|`None`|
