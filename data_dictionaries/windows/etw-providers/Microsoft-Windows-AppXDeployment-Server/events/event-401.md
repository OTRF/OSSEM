# Event 401 - AppXDeployment.Task.Server.Deployment
###### Version: 0
...
|TBD|IsInPlaceUpdate|HexInt32|None|`None`|
|TBD|ErrorFileInfo|UnicodeString|None|`None`|
|TBD|DetailedMessageInfo|UnicodeString|None|`None`|
|TBD|IsOptional|UInt32|None|`None`|
