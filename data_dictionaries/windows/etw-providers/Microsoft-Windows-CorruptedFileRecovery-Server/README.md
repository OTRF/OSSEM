# Microsoft-Windows-CorruptedFileRecovery-Server ETW events

## Description
This page contains the list of events for Microsoft-Windows-CorruptedFileRecovery-Server, as collected by the Event Tracing for Windows.
...
|[8](events/event-8.md)|0|None|etw_level_Critical, etw_task_task_0|
