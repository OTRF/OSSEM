# Microsoft-Windows-DAL-Provider ETW events

## Description
This page contains the list of events for Microsoft-Windows-DAL-Provider, as collected by the Event Tracing for Windows.
