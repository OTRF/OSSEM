...
| [Audit Distribution Group Management](https://github.com/Cyb3rWard0g/OSSEM/blob/master/data_dictionaries/windows/security/account_management/distribution_group_management/README.md) | Audit Distribution Group Management determines whether the operating system generates audit events for specific distribution-group management tasks | Low on domain controllers |
