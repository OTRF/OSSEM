...
|	source_host_name	|	WorkstationName	|	string	|	machine name from which logon attempt was performed.	|	DC01	|
...
|	source_ip_address	|	IpAddress	|	integer	|	IP address of machine from which logon attempt was performed	|	127.0.0.1	|
|	source_ip_port	|	IpPort	|	string	|	source port which was used for logon attempt from remote machine. 0 for interactive logons	|	0	|