...
|---|---|---|---|---|
|process_id|ProcessId|TBD|integer|Hexadecimal Process ID of the process which was permitted to bind to the local port.|7924|
...
|TBD|FilterRTID|TBD|integer|Unique filter ID which blocks the application from binding to the port.|84614|
