...
|---|---|---|---|---|
|target_user_old_name|OldTargetUserName|TBD|string|old name of target account.|Admin|
|target_user_new_name|NewTargetUserName|TBD|string|new name of target account.|MainAdmin|
|target_user_domain|TargetDomainName|TBD|string|target account's domain or computer name.|CONTOSO|
|target_user_sid|TargetSid|TBD|string|SID of account on which the name was changed.|S-1-5-21-3457937927-2839227994-823803824-6117|
|user_sid|SubjectUserSid|TBD|string|SID of account that performed the "change account name" operation.|S-1-5-21-3457937927-2839227994-823803824-1104|
|user_name|SubjectUserName|TBD|string|the name of the account that performed the "change account name" operation.|dadmin|
