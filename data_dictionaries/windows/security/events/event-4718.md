...
|---|---|---|---|---|
|TBD|AccessRemoved|TBD|string|the name of removed logon right.|SeChangeNotifyPrivilege|
|user_sid|SubjectUserSid|TBD|string|SID of account that made a change to local logon right user policy.|SYSTEM|
|user_name|SubjectUserName|TBD|string|the name of the account that made a change to local logon right user policy.|DC01$|
...
|target_user_sid|TargetSid|TBD|string|the SID of the security principal for which logon right was removed.|THEDOMAIN\AnotherUser|
