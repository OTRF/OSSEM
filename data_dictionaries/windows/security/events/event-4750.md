...
|---|---|---|---|---|
|group_name|TargetUserName|TBD|string|the name of the group that was changed. For example: ServiceDesk|ServiceDeskMain|
|group_domain|TargetDomainName|TBD|string|domain name of changed group.|CONTOSO|
|group_sid|TargetSid|TBD|string|SID of changed group. Event Viewer automatically tries to resolve SIDs and show the group name. If the SID cannot be resolved, you will see the source data in the event.|S-1-5-21-3457937927-2839227994-823803824-6119|
|user_sid|SubjectUserSid|TBD|string|SID of account that requested the "change group" operation. Event Viewer automatically tries to resolve SIDs and show the account name.|S-1-5-21-3457937927-2839227994-823803824-1104|
