...
|---|---|---|---|---|
|profile_changed|ProfileChanged|TBD|string|the list of profiles to which new rule was applied.|All|
|rule_id|RuleId|TBD|string|the unique new firewall rule identifier.|{F2649D59-1355-4E3C-B886-CDD08B683199}|
|rule_name|RuleName|TBD|string|the name of the rule which was added.|Allow All Rule|
