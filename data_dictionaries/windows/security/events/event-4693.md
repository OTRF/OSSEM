...
|master_key_id|MasterKeyId|TBD|string|unique identifier of a master key which was recovered.|0445c766-75f0-4de7-82ad-d9d97aad59f6|
|recovery_key_reason|RecoveryReason|TBD|integer|hexadecimal code of recovery reason.|0x5c005c|
|target_host_name|RecoveryServer|TBD|string|the name (typically - DNS name) of the computer that you contacted to recover your Master Key.|DC01.contoso.local|
|recovery_key_id|RecoveryKeyId|TBD|string|unique identifier of a recovery key.|None|
|event_failure_reason|FailureId|TBD|integer|hexadecimal unique status code.|0x380000|
