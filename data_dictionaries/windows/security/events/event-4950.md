...
|---|---|---|---|---|
|profile_changed|ProfileChanged|TBD|string|the name of profile in which setting was changed.|Domain|
|setting_type|SettingType|TBD|string|the name of the setting which was modified.|Default Outbound Action|
|setting_value|SettingValue|TBD|string|new value of modified setting.|Block|
