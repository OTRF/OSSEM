...
|---|---|---|---|---|
|TBD|AccessGranted|TBD|string|the name of granted logon right.|SeChangeNotifyPrivilege|
|user_sid|SubjectUserSid|TBD|string|SID of account that made a change to local logon right user policy.|DADOMAIN\DaUser|
|user_name|SubjectUserName|TBD|string|the name of the account that made a change to local logon right user policy.|DaUser|
|user_domain|SubjectDomainName|TBD|string| subject's domain or computer name.|DADOMAIN|
...
|target_user_sid|TargetSid|TBD|string|the SID of the security principal for which logon right was granted.|S-1-5-21-3457937927-2839227994-823803824-2104|
