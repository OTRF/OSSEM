...
|---|---|---|---|---|
|user_sid|SubjectUserSid|TBD|string|SID of account that requested the "disable scheduled task" operation. |THEDOMAIN\TheUser|
|user_name|SubjectUserName|TBD|string|the name of the account that requested the "disable scheduled task" operation.|TheUser|
|user_domain|SubjectDomainName|TBD|string|subject's domain or computer name.|THEDOMAIN|
|user_logon_id|SubjectLogonId|TBD|integer|hexadecimal value that can help you correlate this event with recent events that might||
...
|scheduled_task_name|TaskName|TBD|string|disabled scheduled task name.|\ImportantTask|
