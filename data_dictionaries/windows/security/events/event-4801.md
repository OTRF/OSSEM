...
|---|---|---|---|---|
|user_sid|TargetUserSid|TBD|string|SID of account that requested the "unlock workstation" operation|S-1-5-21-3457937927-2839227994-823803824-1104|
|user_name|TargetUserName|TBD|string|the name of the account that requested the "unlock workstation" operation.|dadmin|
...
|user_session_id|SessionId|TBD|integer|unique ID of unlocked session.|3|
