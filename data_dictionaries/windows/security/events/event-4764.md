...
|---|---|---|---|---|
|group_type_change|GroupTypeChange|string|contains three parts: " Changed To .". They cannot have the same value at the same time|`Security Enabled Local Group Changed to Security Disabled Local Group`|
