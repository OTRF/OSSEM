...
|	user_access_list	|	AccessList	|	string	|	the list of access rights which were requested by `user_sid`. These access rights depend on Object Type.	|	%%1541 %%4416 %%4423	|
