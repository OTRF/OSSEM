...
|---|---|---|---|---|
|user_sid|SubjectUserSid|TBD|string|SID of account that disabled the device.|S-1-5-18|
|user_name|SubjectUserName|TBD|string|the name of the account that disabled the device.|DESKTOP-NFC0HVN$|
