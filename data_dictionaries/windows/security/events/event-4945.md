...
|---|---|---|---|---|
|profile_used|ProfileUsed|TBD|string|the name of the profile that the rule belongs to. It always has value "Public", because this event shows rules only for "Public" profile.|Public|
|rule_id|RuleId|TBD|string|the unique firewall rule identifier.|NPS-NPSSvc-In-RPC|
|rule_name|RuleName|TBD|string|the name of the rule which was listed when the Windows Firewall started.|Network Policy Server (RPC)|
