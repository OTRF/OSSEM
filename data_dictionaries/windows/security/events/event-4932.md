...
|session_id|SessionID|TBD|integer|unique identifier of replication session. Using this field you can find "4932: Synchronization of a replica of an Active Directory naming context has begun." and "4933: Synchronization of a replica of an Active Directory naming context has ended." events for the same session.|48|
|start_usn|StartUSN|TBD|integer|Naming Context's USN number before replication begins.|20869|
