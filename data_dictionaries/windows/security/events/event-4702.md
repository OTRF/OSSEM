...
|---|---|---|---|---|
|user_sid|SubjectUserSid|TBD|string|SID of account that requested the "change/update scheduled task" operation.|THEDOMAIN\UserB|
|user_name|SubjectUserName|TBD|string|the name of the account that requested the "change/update scheduled task" operation.|UserB|
