...
|user_logon_id|SubjectLogonId|integer|hexadecimal value that can help you correlate this event with recent events that might contain the same Logon ID, for example, "4624: An account was successfully logged on".|0x48f29|
|@date_previous_time|PreviousTime|string|previous time in UTC time zone.|2015-10-09T05:04:30.000941900Z|
|@date_new_time|NewTime|string|new time that was set in UTC time zone.|2015-10-09T05:04:30.000000000Z|
