...
|---|---|---|---|---|
|profile_changed|ProfileChanged|TBD|string|the list of profiles to which changed rule is applied.|All|
|rule_id|RuleId|TBD|string|the unique identifier for modified firewall rule.|{F2649D59-1355-4E3C-B886-CDD08B683199}|
|rule_name|RuleName|TBD|string|the name of the rule which was modified.|Allow All Rule|
