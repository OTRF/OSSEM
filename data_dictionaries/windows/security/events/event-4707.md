...
|---|---|---|---|---|
|trust_domain|DomainName|TBD|string|the name of removed trusted domain.|FABRIKAM|
|trust_sid|DomainSid|TBD|string|SID of removed trusted domain.|S-1-5-21-2226861337-2836268956-2433141405|
|user_sid|SubjectUserSid|TBD|string|SID of account that requested the "remove domain trust" operation.|S-1-5-21-3457937927-2839227994-823803824-1104|
|user_name|SubjectUserName|TBD|string|the name of the account that requested the "remove domain trust" operation.|dadmin|
