...
| Account Logon	| Credential Validation	| [4776](https://github.com/Cyb3rWard0g/OSSEM/blob/master/data_dictionaries/windows/security/account_logon/event-4776.md) | The domain controller attempted to validate the credentials for an account. | Windows Vista, Windows Server 2008 |
