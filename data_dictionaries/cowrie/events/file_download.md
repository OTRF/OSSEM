...
## Description
This dictionary details the fields for the file upload event of the Cowrie honeypot, which triggers when a file is downloaded to the honeypot, for example with wget.
...
|file_name|filename|string|The name of the file downloaded|`bad.exe`|
...
|TBD|destfile|string|The path where the file is stored on the honeypot file system|`/root/bad.exe`|
|url_original|url|string|The url from which the file was downloaded|`https://google.com`|
