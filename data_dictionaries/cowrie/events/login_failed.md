...
## Description
This dictionary details the fields for the login failed event of the Cowrie honeypot.
...
|user_name|username|string|Username used for the failed login|`root`|
|user_password|password|string|Password used for the failed login|`root`|

## References
* [Cowrie authentication checking code](https://github.com/cowrie/cowrie/blob/master/src/cowrie/core/checkers.py#L113)
