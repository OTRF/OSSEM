...
## Description
This dictionary details the fields for the command input of the Cowrie honeypot, which triggers when a command is input in an interactive session.
...
|process_command_line|input|string|A command that was executed in a cowrie session|`wget google.ch`|

## References
* [Cowrie fake shell code](https://github.com/cowrie/cowrie/blob/master/src/cowrie/shell/honeypot.py#L39)
