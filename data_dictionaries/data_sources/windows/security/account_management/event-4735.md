...
|	----------------	|	----------------	|	----------------	|	----------------	|
|	TargetUserName	|	string	|	the name of the group that was changed. For example: ServiceDesk	|	AccountOperators\_NEW	|
|	TargetDomainName	|	string	|	SID of changed group.	|	CONTOSO	|
|	TargetSid	|	string	|	SID of changed group.	|	S-1-5-21-3457937927-2839227994-823803824-6605	|
|	SubjectUserSid	|	string	|	SID of account that requested the “change group” operation. Event Viewer automatically tries to resolve SIDs and show the account name. If the SID cannot be resolved, you will see the source data in the event.	|	S-1-5-21-3457937927-2839227994-823803824-1104	|
|	SubjectUserName	|	string	|	the name of the account that requested the “change group” operation.	|	dadmin	|
