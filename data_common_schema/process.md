...
|	src_process_guid	|	string	|	Process Guid of the source process that created a thread in another process (target)	|	{A98268C1-9586-5ACD-0000-001070A20000}	|
|	src_process_id	|	integer	|	Process ID used by the os to identify the source process that created a thread in another process (target)	|	684	|
...
|	source_process_name	|	string	|	TThe name of the executable without full path related to the source process that created a thread in another process (target)|	svchost.exe	|
