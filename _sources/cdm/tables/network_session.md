...
|:---|:---|:---|:---|:---|
 ...
 | destination | dst_mac_addr | mac | MAC address of an endpoint or network interface where a connection starts or ends. | 00:11:22:33:44:55 |
 ...
 | event | event_product | string | The product generating the event. | OfficeSharepoint |
 | event | event_product_ver | string | The version of the product generating the event | 0.2 |
 ...
 | source | src_mac_addr | mac | MAC address of an endpoint or network interface where a connection starts or ends. | 00:11:22:33:44:55 |
