...
| win registry key creation | process | created | win registry key|
| win registry key deletion | process | deleted | win registry key|
| win registry key modification | process | modified | win registry key|
